...
export const SCore_Editor_ButtonManager = () => {
    ...
    const changeMenu = (id: string) => {currentToolVar.setCurrentToolMenu({type: id})}
            ...
            {buttonList.map((item, index) => {
                return (
                    <button key={index} className={
                        (JSON.stringify(index) == currentToolVar.currentToolMenu?.type) ? "score_button-selected text-center z-10 relative" : "score_button text-center z-10 relative"} 
